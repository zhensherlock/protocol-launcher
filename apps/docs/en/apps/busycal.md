...
<div class="flex justify-center gap-3">
  <VPLink :href="find(findParams)" target="_self">Find Item</VPLink>
  <VPLink :href="openDate(openDateParams)" target="_self">Open Date</VPLink>
  <VPLink :href="openFilter(openFilterParams)" target="_self">Open Filter</VPLink>
</div>
...
<div class="flex justify-center gap-3">
  <VPLink :href="openEventQuickEntry()" target="_self">Event Quick Entry</VPLink>
  <VPLink :href="openTaskQuickEntry()" target="_self">Task Quick Entry</VPLink>
  <VPLink :href="subscribeCalendar(subscribeCalendarParams)" target="_self">Subscribe Calendar</VPLink>
</div>
...
<div class="flex justify-center gap-3">
  <VPLink :href="newIosEvent(newIosEventParams)" target="_self">New iOS Event</VPLink>
  <VPLink :href="openIosDate(openIosDateParams)" target="_self">Open iOS Date</VPLink>
  <VPLink :href="launchIosView(launchIosViewParams)" target="_self">Open iOS View</VPLink>
</div>
