...
[TextMate](https://macromates.com/) is a general-purpose GUI text editor for macOS. **Protocol Launcher** allows you to generate deep links to open and configure resources in TextMate.
