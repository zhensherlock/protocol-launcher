...
import { coordinates, route, search, view } from 'protocol-launcher/inroute';
import { SelectInstallationMethod } from '../../.vitepress/components';
import {
  coordinatesParams,
  returnToCallerParams,
  routeParams,
  searchParams,
  viewParams,
} from '../../.vitepress/constants/inroute';

const currentMethod = ref('On-Demand');
const importPath = computed(() => currentMethod.value === 'On-Demand' ? 'protocol-launcher/inroute' : 'protocol-launcher');
</script>
...
<div class="flex justify-center">
  <VPLink :href="coordinates(coordinatesParams)" target="_self">
    Import Coordinates
  </VPLink>
</div>
...
<div class="flex justify-center">
  <VPLink :href="view(returnToCallerParams)" target="_self">
    View with Return URL
  </VPLink>
</div>
