...
import { clientUrlParams } from '../../.vitepress/constants/microsoft-onenote';

const currentMethod = ref('On-Demand');
const importPath = computed(() =>
  currentMethod.value === 'On-Demand' ? 'protocol-launcher/microsoft-onenote' : 'protocol-launcher',
);
</script>
...
<div class="flex justify-center">
  <VPLink :href="openClientUrl(clientUrlParams)" target="_self">
    Open OneNote Client URL
  </VPLink>
</div>
