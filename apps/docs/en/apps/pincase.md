...
import { addBookmark, open, openRecent, openTag, openUnread } from 'protocol-launcher/pincase';
import { SelectInstallationMethod } from '../../.vitepress/components';
import { addBookmarkParams, addBookmarkWithCallbacksParams, openPublicTagParams, openTagParams } from '../../.vitepress/constants/pincase';

const currentMethod = ref('On-Demand');
const importPath = computed(() => currentMethod.value === 'On-Demand' ? 'protocol-launcher/pincase' : 'protocol-launcher');
</script>
...
<div class="flex justify-center">
  <VPLink :href="addBookmark(addBookmarkWithCallbacksParams)" target="_self">
    Add Bookmark with Callbacks in Pincase
  </VPLink>
</div>
...
<div class="flex justify-center">
  <VPLink :href="open(openPublicTagParams)" target="_self">
    Open Public Tag in Pincase
  </VPLink>
</div>
...
<div class="flex justify-center">
  <VPLink :href="openUnread()" target="_self">
    Open Unread in Pincase
  </VPLink>
</div>
