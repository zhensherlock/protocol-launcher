...
import {
  openFileParams,
  openFolderParams,
} from '../../.vitepress/constants/idea';

const appStore = useAppStore();
const currentMethod = ref('On-Demand');
const importPath = computed(() => currentMethod.value === 'On-Demand' ? 'protocol-launcher/idea' : 'protocol-launcher');
</script>

# IntelliJ IDEA

[IntelliJ IDEA](https://www.jetbrains.com/idea/) 是一款用于 JVM 及多语言开发的集成开发环境。**Protocol Launcher** 允许你生成深度链接，用于在 IntelliJ IDEA 中打开并配置资源。
