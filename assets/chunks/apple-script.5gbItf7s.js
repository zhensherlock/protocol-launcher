function e(){return`applescript://com.apple.scripteditor`}function t(e){let{script:t}=e;return`applescript://com.apple.scripteditor?script=${encodeURIComponent(t)}`}var n={script:`display dialog "Hello, World!"`},r={script:`set oldClipboard to the clipboard
