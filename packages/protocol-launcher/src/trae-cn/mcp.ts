...
/**
 * Install MCP Server in Trae China.
 ...
 * })
 * // => 'trae-cn://trae.ai-ide/mcp-import?%7B...%7D&windowId=_blank'
...
export function installMCP(payload: MCPServer) {
  ...
  return `trae-cn://trae.ai-ide/mcp-import?name=${name}&type=${type}&config=${encodedPayload}${openInNewWindow ? '&windowId=_blank' : ''}`
}
